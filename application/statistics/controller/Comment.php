...
class Comment { 
    ...
    */
     ...
     * @return     array    data     返回的数据 
     */
    public function praiseWeekStatistics($data = []) {
        try{ 
            //$data = input('param.'); //2019-04-21 注释
    ...
    //获取项目拨打电话信息 ，
    public function get_items_click_number($entity_param = []) {
        $return_data = array(
            'data' => [],
            'message' => '',
            'code'=> 201,
    ...
    public function get_share_items_link($entity_param = []) {
        $return_data = array(
            'data' => [],
            'message' => '',
            'code'=> 201,
