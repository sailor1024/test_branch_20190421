...
class Location {
    ...
    //获取大洲的访问数据
    public function get_UserCountry_getContinent($entity_param = []) {
        //设置默认天数
        $now_time = time();
    ...
    //获取国家的访问数据
    public function get_UserCountry_getCountry($entity_param = []) {
        //设置默认天数
        $now_time = time();
        $today_time = date("Y-m-d", $now_time  );
        $yesterday_time = date("Y-m-d",($now_time - 60*60*24)); //昨天
    ...
    //获取国家的省份的访问数据
    public function get_UserCountry_getRegion($entity_param = []) {  
        //设置默认天数
        $now_time = time();
        $today_time = date("Y-m-d", $now_time  );
        $yesterday_time = date("Y-m-d",($now_time - 60*60*24)); //昨天
    ...
    /* public function get_UserCountry_getCity($entity_param = []){
        //设置默认天数
        $now_time = time();
        $today_time = date("Y-m-d", $now_time  );
        $yesterday_time = date("Y-m-d",($now_time - 60*60*24)); //昨天
