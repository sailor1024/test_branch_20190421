...
<div class="itemList">
  ...
  <item-list-page :current="parseInt($route.query.page)" :count="countnum" v-if="issoure" @pagechange="soureChange"></item-list-page>
...
export default {
  ...
  methods: {
    ...
    loadData (params) {
      ...
      this.$http.post('index2/file/search', {
        key: params.q,
        type: params.t,
        page: params.page
      }).then(res => {
